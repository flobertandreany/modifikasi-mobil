            ...
            <tbody>
                @foreach ($store as $s)
                    <tr>
                        ...
                        <td>{{ $s->store_code }}</td>
                        <td>
                            <a href="{{ route('view.store.product.list', ['id' => $s->id]) }}" class="button-detail btn btn-secondary btn-sm">
                                See Products
                            </a>
                        </td>
                        <td>
                        ...
                        <td style="border-right: 0px; padding: 15px 0 15px 0;">
                            <button type="submit" name="reject" onclick="delete_button({{ $s->id }})" class="button-a btn btn-sm" style="background-color: red;">
                                Delete
                            </button>
                        </td>
                    </tr>
